...
const News = () => {
  ...
  const mockNews = [
    {
      ...
      titleEn: 'We Took Our Place at 31st Marble Izmir International Natural Stone and Technologies Fair',
      summaryTr: '31.Marble İzmir Uluslarası fuarında yeni geliştirdiğimiz ürünlerimiz yoğun ilgi gördü.',
      summaryEn: 'We exhibited our newly developed products at our stand at the 31st Marble Izmir International Natural Stone and Technologies Fair and received great interest.',
    ...
    },
    {
      ...
      titleEn: 'We Are Participating in Block Marble Fair',
      summaryTr: 'Tamis olarak 2.Afyonkarahisar Blok Mermer Fuarına katılıyoruz.',
      summaryEn: 'We will participate in the 2nd Afyonkarahisar Block Marble Fair.',
      contentTr: 'Detaylı haber içeriği...',
      contentEn: 'Detailed news content...',
      category: 'event',
    ...
    {
      id: 3,
      titleTr: 'Markalaşıyoruz',
      titleEn: 'We Are Branding',
      summaryTr: 'Tamis olarak "İsmail Usta" ismini markamız olarak belirledik.',
      summaryEn: 'We have chosen "İsmail Usta" as our brand name.',
      contentTr: 'Detaylı haber içeriği...',
      contentEn: 'Detailed news content...',
  ...
  const getCategoryLabel = (cat) => {
    ...
    return category ? (i18n.language === 'tr' ? category.labelTr : category.labelEn) : cat
  }
  ...
  return (
    <>
      <Helmet>
        <title>Tamis Tarımsal Mühendislik İnşaat Sanayi Ticaret Ltd. Şti. {t('nav.news')}</title>
        <meta name="description" content="Haberler, basın açıklamaları ve duyurular" />
      </Helmet>
      ...
      <div className="relative pt-20 bg-gradient-to-r from-navy-900 to-navy-800">
        <div className="container-custom py-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl">
            {i18n.language === 'tr' 
              ? 'Son gelişmeler, basın açıklamaları ve duyurularımız.'
              : 'Latest developments, press releases and announcements.'}
          </p>
        </div>
      </div>

      {/* Öne Çıkan Haberler - TAM BOYUT FOTO */}
      {featuredNews.length > 0 && (
        <div className="py-12">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-white mb-8">
              {i18n.language === 'tr' ? 'Öne Çıkan Haberler' : 'Featured News'}
            </h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {featuredNews.map((item) => (
                ...
                >
                  {/* FOTO TAM BOY - YÜKSEKLİK BÜYÜTÜLDÜ */}
                  <div className="relative h-[400px] md:h-[500px] w-full overflow-hidden">
                    ...
                    {/* Koyu gradient overlay - yazıların okunması için */}
                    ...
                    <div className="absolute top-6 right-6 z-10">
                      <span className="bg-black/60 backdrop-blur-sm text-white text-sm px-4 py-1.5 rounded-full font-medium">
                        {new Date(item.publishDate).toLocaleDateString(i18n.language === 'tr' ? 'tr-TR' : 'en-US')}
                      </span>
                    </div>
                    
                    {/* İçerik - FOTO ALTINDA DEĞİL, FOTO ÜZERİNDE */}
                    <div className="absolute bottom-0 left-0 right-0 p-8 z-10">
                      ...
                      <p className="text-gray-200 line-clamp-2 text-base md:text-lg mb-4">
                        {i18n.language === 'tr' ? item.summaryTr : item.summaryEn}
                      </p>
      ...
      <Section>
        ...
        {/* Haber Grid - Diğer haberler de tam boyut */}
