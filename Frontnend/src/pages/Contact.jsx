  ...
  const contactInfo = [
    {
      ...
      titleEn: 'Address',
      details: [
        'Saray Mah. 50.Cad. 17/C Kahramankazan',
        'Ankara/Türkiye 06980'
      ],
link: 'https://maps.google.com/?q=40.04281738036737, 32.59818695602955'      
  ...
  const productCategories = [
    ...
    { value: 'hydraulic', labelTr: 'Yağlama Sistemleri', labelEn: 'Hydraulic Systems', icon: '🔩' },
  ...
  return (
    <>
      <Helmet>
        <title>TAMİS | {t('nav.contact')} - İletişim ve İhracat Bilgi Formu</title>
        <meta name="description" content="TAMİS ile iletişime geçin. Savunma sanayi ürünlerimiz, ihracat talepleri ve kurumsal iletişim için bize ulaşın." />
        <meta name="keywords" content="tamis iletişim, savunma sanayi iletişim, ihracat formu, teklif al" />
      </Helmet>
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-gray-300 leading-relaxed animate-fade-in">
              {i18n.language === 'tr' 
                ...
                : 'Contact us for your defense industry needs. Our expert team will get back to you as soon as possible.'}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-1 space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold mb-2">
                        {i18n.language === 'tr' ? info.titleTr : info.titleEn}
                      </h3>
              ...
              <div className="bg-navy-800/50 rounded-xl p-6 border border-navy-700">
                <h3 className="text-white font-semibold mb-4">
                  {i18n.language === 'tr' ? 'Sosyal Medya' : 'Social Media'}
                </h3>
...
>
  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.85 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.85-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
                  ...
                  <a href="https://www.linkedin.com/in/tamis-makine-54aa64409/" className="w-10 h-10 bg-navy-700 hover:bg-navy-600 rounded-full flex items-center justify-center transition-colors">
              ...
              <div className="bg-navy-800/50 rounded-xl border border-navy-700 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-navy-700 to-navy-800 px-6 py-4 border-b border-navy-600">
                  <h3 className="text-xl font-bold text-white">
                    {i18n.language === 'tr' ? 'İhracat ve Tedarik Bilgi Formu' : 'Export and Supply Information Form'}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        placeholder={i18n.language === 'tr' ? 'Firma adı' : 'Company name'}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-input"
                        placeholder={i18n.language === 'tr' ? 'Ülke' : 'Country'}
                      />
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className="form-input"
                        placeholder={i18n.language === 'tr' ? 'Yetkili adı soyadı' : 'Full name'}
                      />
                    ...
                    <div className="form-group md:col-span-2">
                      ...
                      <select
                        ...
                        className="form-input"
                      >
                        <option value="">{i18n.language === 'tr' ? 'Ürün seçiniz' : 'Select product'}</option>
                        {productCategories.map((cat) => (
                          <option key={cat.value} value={cat.value}>
                            {cat.icon} {i18n.language === 'tr' ? cat.labelTr : cat.labelEn}
                          </option>
                        ))}
                      </select>
                    </div>
                    ...
                    <div className="form-group md:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder={i18n.language === 'tr' 
                          ? 'Teknik gereksinimleriniz, talep ettiğiniz ürünler ve proje detayları hakkında bilgi verebilirsiniz...' 
                          : 'You can provide information about your technical requirements, requested products and project details...'}
                      ></textarea>
