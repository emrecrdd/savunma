...
const Home = () => {
  ...
  const products = [
    {
      ...
      pdf: '/brochures/tamis-katalog-2024.pdf'
    },
    {
      id: 2,
  ...
  const schemaData = {
    ...
    "@type": "LocalBusiness",
    "name": "TAMİS",
    "alternateName": "Tamis Tarımsal Mühendislik İnşaat Sanayi Ticaret Ltd. Şti.",
    "url": "https://tamismakine.com.tr",
    "logo": "https://tamismakine.com.tr/images/logo5.png",
    "image": "https://tamismakine.com.tr/images/og-image.jpg",
    "description": currentLang === 'tr' 
      ? "TAMİS, Ankara Kahramankazan merkezli 39 yıllık tecrübe ile tarım, inşaat ve madencilik sektörlerine yedek parça ve makine ekipmanları üretmektedir."
      : "TAMİS, with 39 years of experience based in Kahramankazan, Ankara, produces spare parts and machinery equipment for agriculture, construction and mining sectors.",
    "address": {
      "@type": "PostalAddress",
    ...
    "priceRange": "₺₺",
    "sameAs": [
      "https://www.instagram.com/tamis.makine/",
      "https://www.linkedin.com/in/tamis-makine-54aa64409/"
    ]
  }
  ...
  return (
    <>
      <Helmet>
        ...
        <title>{currentLang === 'tr' ? 'TAMİS | Ankara Tarım ve Makine Yedek Parça Üreticisi' : 'TAMİS | Ankara Agriculture & Machine Spare Parts Manufacturer'}</title>
        ...
        <meta name="keywords" content="TAMİS, Ankara, yedek parça, tarım makineleri, inşaat ekipmanları, madencilik, CNC işleme, Kahramankazan, makine yedek parça, endüstriyel ekipman" />
        
        <meta name="robots" content="index, follow" />
        <meta name="googlebot" content="index, follow" />
        <meta name="author" content="TAMİS" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        
        {/* Canonical URL */}
        <link rel="canonical" href={`https://tamismakine.com.tr${currentLang === 'en' ? '/en' : ''}`} />
        
        {/* Dil alternatifleri */}
        <link rel="alternate" href="https://tamismakine.com.tr/" hrefLang="tr" />
        <link rel="alternate" href="https://tamismakine.com.tr/en" hrefLang="en" />
        <link rel="alternate" href="https://tamismakine.com.tr/" hrefLang="x-default" />
        
        {/* Open Graph / Sosyal Medya */}
        <meta property="og:title" content={currentLang === 'tr' ? 'TAMİS | Ankara Tarım ve Makine Yedek Parça Üreticisi' : 'TAMİS | Ankara Agriculture & Machine Spare Parts Manufacturer'} />
        <meta property="og:description" content={currentLang === 'tr' ? '39 yıllık tecrübe ile tarım, inşaat ve madencilik sektörlerine yedek parça üretimi.' : 'Spare parts manufacturing for agriculture, construction and mining with 39 years of experience.'} />
        <meta property="og:image" content="https://tamismakine.com.tr/images/og-image.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta property="og:url" content={`https://tamismakine.com.tr${currentLang === 'en' ? '/en' : ''}`} />
        ...
        <meta name="twitter:title" content={currentLang === 'tr' ? 'TAMİS | Ankara Tarım ve Makine Yedek Parça Üreticisi' : 'TAMİS | Ankara Agriculture & Machine Spare Parts Manufacturer'} />
            ...
            <div key={product.id} className="group relative bg-gradient-to-b from-navy-800 to-navy-900 rounded-xl overflow-hidden border border-navy-700 hover:border-navy-500 transition-all duration-500 hover:shadow-2xl">
              ...
              <div className="p-6 relative z-10">
                <h3 className="text-xl font-bold text-white mb-3">
                  <Link to={`/products/${product.id}`} className="hover:text-navy-300 transition-colors">
                    {product.title}
                  </Link>
                </h3>
            ...
            <div key={item.id} className="group bg-navy-800/50 rounded-xl overflow-hidden border border-navy-700 hover:border-navy-500 transition-all hover:transform hover:-translate-y-1 duration-300">
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-navy-300 transition-colors line-clamp-2">
                  <Link to={`/news/${item.id}`} className="hover:text-navy-300">
                    {item.title}
                  </Link>
                </h3>
      ...
      <Section className="bg-gradient-to-r from-navy-900 to-navy-800">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/catalogs/tamis-katalog-2024.pdf" className="btn-outline text-lg px-8 py-4" download>{t('home.catalog')}</a>
          </div>
